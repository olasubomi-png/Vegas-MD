...
function getMentionedJid(message) {
  // Check contextInfo across every possible message container so that
  // .promote/.demote works whether the command is typed as a mention,
  // a reply to a text, or a reply to an image/video/sticker/audio.
